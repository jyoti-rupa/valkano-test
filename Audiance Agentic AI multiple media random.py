...
questions_overview =["Identify my target audience and describe their demographic and psychographic traits.",
                         "What are my target audience’s favorite titles?"]
...
for media_id in media_ids:
    ...
    wait.until(
        EC.element_to_be_clickable(
            (By.XPATH, "/html/body/div[2]/main/div/div/div[3]/div/button[2]")
        )
    ).click()
